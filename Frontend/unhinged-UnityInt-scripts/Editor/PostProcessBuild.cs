...
//referenced: https://github.com/bdeweygit/unity-swiftui
//script automates xcode project file linking
...
public class PostProcessBuild
{
    ...
    public static void OnPostProcessBuild(BuildTarget target, string buildPath)
    {
        ...
        if (target == BuildTarget.iOS)
        {
            ...
            string pluginHeaderGuid = project.FindFileGuidByProjectPath("Libraries/Plugins/NativeState.h");
            ...
            FileUtil.ReplaceFile("Assets/Plugins/UnityFramework.modulemap", modulemapAbsolutePath);
